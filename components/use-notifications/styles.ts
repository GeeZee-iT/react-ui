...
import { NotificationColors } from 'components/utils/prop-types'
...
export const getStyles = (
  ...
  color: NotificationColors | undefined,
): NotificationColorGroup => {
  const category: { [key in NotificationColors]: NotificationColorGroup } = {
    default: {
  ...
  let result: NotificationColorGroup
  if (!color) {
