...
| **iconRightClickable** | right icons are clickable     | `boolean`                                      | -                                       | `false`   |
| **onIconClick**        | icon click event              | `(e: React.ChangeEvent) => void`               | -                                       | -         |
| **onIconRightClick**   | right icon click event        | `(e: React.ChangeEvent) => void`               | -                                       | -         |
| **onChange**           | change event                  | `(e: React.ChangeEvent) => void`               | -                                       | -         |
| **onClearClick**       | icon clear event              | `(e: React.MouseEvent) => void`                | -                                       | -         |
